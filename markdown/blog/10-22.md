...
- [Collecting Seashells](https://wiki.c2.com/?CollectingSeashells).
  A parable on quality, selection, and curation. The third and fourth collectors get the best results, but what about the dozens of good results that are discarded. For me, the whole story opens up a fundamental discussion on what goodness means in art and in life.
...
- [invoke-ai/InvokeAI](https://github.com/invoke-ai/InvokeAI). Very good SD UI can recommend.
- [The Ultimate Art Generation Application.](https://prompt.art/)
...
Have not really tried any of these, saved them for future reference. The JSON visualization and Pocketbase seem particularly useful. The photo colorization and video transcription work like magic.
