...
- TODO: Write a short (horror?) story out of this: "The bioreactor device triggered very complex downstream outcomes that bio-engineers cannot yet micromanage directly."
...
- [Maybe Passwords are the Future](https://kevincox.ca/2022/04/07/passwords/).  Passwords good.
...
- [TIL](https://english.stackexchange.com/questions/31430/what-is-the-origin-of-daemon-with-regards-to-computing) the `daemon` in computing likely comes from [Maxwells Demon](https://en.wikipedia.org/wiki/Maxwell%27s_demon)
...
- [Objection Maker](objection.lol). Meme generator  from Ace Attorney.
