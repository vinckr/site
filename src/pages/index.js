...
const IndexPage = () => (
  ...
  <p>
    Feel free to write me <a href="mailto:hi@vinckr.com">an email</a> about anything, I would love to hear from you!</p>
  <p>
    Have a look around, I collect interesting <Link to="/links">links</Link> and hack away at a <Link to="/blog">blog</Link>.
  </p>
